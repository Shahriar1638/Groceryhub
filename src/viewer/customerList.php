                        ...
                        if (mysqli_num_rows($result) > 0){
                            while ($row = mysqli_fetch_assoc($result)){
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php if ($banStatus == '0') { ?>
                                            <button class="px-6 py-2 rounded-md bg-green-500 uppercase text-white" onclick="handleBanStatus('<?php echo $customerEmail ?>', 'unban')">Unban</button>
                                        <?php } else { ?>
                                            <button class="px-6 py-2 rounded-md bg-red-500 uppercase text-white" onclick="handleBanStatus('<?php echo $customerEmail ?>', 'ban')">Ban</button>
                                        <?php } ?>
                                    </td>
                                </tr>
                        <?php
