...
CREATE TABLE `payment` (
  ...
  `cvc` char(3) NOT NULL,
  `progress_bar` varchar(20) DEFAULT 'inprogress'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
('b681295336703c5cfa67', 'duck@duck.com', 2.99, 'Fresh Tomato ( 1.00 Kg ) 2.99$ ,', '2024-12-05 18:27:48', '2025-10-21', '123', 'inprogress'),
('bd8f9c1cdd844d2cec75', 'duck@duck.com', 11.02, 'Crispy Lettuce ( 0.50 Kg ) 0.75$ ,Organic Potato ( 2.00 Kg ) 6.98$ ,Red Bell Pepper ( 1.00 Kg ) 3.29$ ,', '2024-12-04 11:42:23', '2025-10-21', '123', 'inprogress'),
('f6a0df9d8f1f66c7d6d7', 'duck@duck.com', 15.94, 'Fresh Tomato ( 2.00 Kg ) 5.98$ ,Crispy Lettuce ( 2.00 Kg ) 2.98$ ,Organic Potato ( 2.00 Kg ) 6.98$ ,', '2024-12-05 18:24:26', '2025-10-21', '123', 'inprogress');
...
INSERT INTO `reports` (`report_id`, `reporter_name`, `reporter_email`, `message`, `time`, `replymessage`, `status`, `selleremail`) VALUES
